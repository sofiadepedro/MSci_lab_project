...
if __name__ == "__main__":
    try:
        ...
        height_check = False
        grid["tactile"] = grid_calculation("tactile", separation_grid, pos=positions)
        grid["tactile"] = shrink_grid(grid["tactile"])
        print(grid["tactile"])
        ...
        grid = zabers["colther"]["x"].gridZs
        homingZabersConcu(zabers, haxes)

        # save all z axis positions
        saveGridIndv("temp_grid", path_data, grid, "tactile")
